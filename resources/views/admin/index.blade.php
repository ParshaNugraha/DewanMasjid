                ...
                @auth
                    ...
                    <div class="top-4 left-4 bg-white p-2 rounded shadow z-50">
                        <p class="text-lg font-semibold text-green-700"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512" class="w-5 h-5 inline"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                <path
