...
<div class="flex justify-center">
    <div class="w-full max-w-screen-lg shadow-lg shadow-green-800">
        ...
        <div class="flex justify-between items-center mb-4 ml-5">
            <h2 class="text-xl font-bold text-green-700">Tentang DMI Jawa Tengah</h2>
        </div>
        <!-- Text Start -->
        <div class="bg-white rounded-xl shadow-md p-6 max-w-4xl mx-auto mt-10 space-y-6">
            <h1 class="text-2xl font-bold text-green-700">🕌 Dewan Masjid Indonesia (DMI)</h1>

            <p class="text-gray-800">
                Dewan Masjid Indonesia (DMI) adalah organisasi kemasyarakatan dan wahana komunikasi pengelola masjid
                seluruh Indonesia
                yang melaksanakan gerakan dakwah, serta menjadikan masjid sebagai pusat kegiatan pembinaan aqidah,
                ibadah, akhlak, ukhuwah,
                keilmuan, keterampilan dan kesejahteraan umat.
            </p>

            <p class="text-gray-800">
                Dewan Masjid Indonesia (DMI) merupakan organisasi tingkat nasional dengan tujuan untuk mewujudkan fungsi
                masjid sebagai
                pusat ibadah, pengembangan masyarakat dan persatuan umat.
            </p>

            <p class="text-gray-800">
                Organisasi ini didirikan pada <strong>22 Juni 1972</strong> dengan maksud untuk meningkatkan keimanan,
                ketaqwaan, akhlaq mulia
                dan kecerdasan umat serta tercapainya masyarakat adil makmur yang diridhai Allah SWT, dalam wilayah
                Negara Republik Indonesia.
            </p>

            <p class="text-gray-800">
                DMI mempunyai kepengurusan di setiap provinsi dan kabupaten/kota di Indonesia. Pimpinan pusat DMI
                dipilih secara demokratis
                setiap lima tahun melalui muktamar.
            </p>
        </div>
