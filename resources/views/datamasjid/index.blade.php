...
<main class="pt-28 md:pt-32 pb-40 bg-gradient-to-b from-green-50 to-gray-50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12 mt-10 animate-fade-in-down">
            <h2 class="text-3xl md:text-4xl font-bold text-green-800 mb-3 bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-emerald-500">
                Data Masjid Provinsi Jawa Tengah
            </h2>
                    ...
                    <div class="overflow-hidden">
                        ...
                        <table class="min-w-full divide-y divide-gray-200/60 border-x border-gray-200/60">
                            <thead class="bg-gradient-to-r from-green-600 to-emerald-500">
                                <tr>
                                    <th class="px-6 py-3 text-start text-xs font-medium text-white uppercase tracking-wider border-r border-white/30">No</th>
                                    <th class="px-6 py-3 text-start text-xs font-medium text-white uppercase tracking-wider border-r border-white/30">Masjid</th>
                                    <th class="px-6 py-3 text-start text-xs font-medium text-white uppercase tracking-wider border-r border-white/30">Gambar</th>
                                    <th class="px-6 py-3 text-start text-xs font-medium text-white uppercase tracking-wider border-r border-white/30">Tipologi</th>
                                    <th class="px-6 py-3 text-start text-xs font-medium text-white uppercase tracking-wider border-r border-white/30">Tahun</th>
                                    <th class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider border-r border-white/30">Kecamatan</th>
                                    <th class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Kabupaten/Kota</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200/30">
                                @foreach($masjids as $index => $masjid)
                                    <tr 
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 border-r border-gray-200/40">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap border-r border-gray-200/40">
                                            <div class="text-sm font-semibold text-green-700 hover:text-green-600 transition-colors">{{ $masjid->nama_masjid }}</div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 border-r border-gray-200/40">
                                            <span class="px-2 py-1 bg-gradient-to-r from-green-100 to-emerald-50 text-green-800 rounded-full text-xs font-medium shadow-sm">
                                                {{ $masjid->topologi_masjid }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 font-medium border-r border-gray-200/40">
                                            {{ $masjid->tahun }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 text-center border-r border-gray-200/40">
                                            <span class="bg-gray-100 px-2 py-1 rounded-md">{{ $masjid->kecamatan }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 text-center font-medium">
                                            <span class="bg-green-50 px-2 py-1 rounded-md text-green-700">{{ $masjid->kabupaten }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
